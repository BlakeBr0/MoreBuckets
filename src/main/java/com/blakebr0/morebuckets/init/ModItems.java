...
public class ModItems {
	...
	public static final RegistryObject<Item> INFERIUM_BUCKET = register("inferium_bucket", () -> new MoreBucketItem(2000, ModConfigs.isMysticalAgricultureInstalled()));
	public static final RegistryObject<Item> PRUDENTIUM_BUCKET = register("prudentium_bucket", () -> new MoreBucketItem(4000, ModConfigs.isMysticalAgricultureInstalled()));
	public static final RegistryObject<Item> TERTIUM_BUCKET = register("tertium_bucket", () -> new MoreBucketItem(8000, ModConfigs.isMysticalAgricultureInstalled()));
	public static final RegistryObject<Item> IMPERIUM_BUCKET = register("imperium_bucket", () -> new MoreBucketItem(16000, ModConfigs.isMysticalAgricultureInstalled()));
	public static final RegistryObject<Item> SUPREMIUM_BUCKET = register("supremium_bucket", () -> new MoreBucketItem(32000, ModConfigs.isMysticalAgricultureInstalled()));
	public static final RegistryObject<Item> INSANIUM_BUCKET = register("insanium_bucket", () -> new MoreBucketItem(64000, ModConfigs.isMysticalAgradditionsInstalled()));
