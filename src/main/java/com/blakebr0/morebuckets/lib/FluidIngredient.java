...
public class FluidIngredient extends Ingredient {
	...
	public boolean test(ItemStack stack) {
		if (stack == null) {
			...
			if (!fluid.isEmpty() && stack.getItem() instanceof ItemMoreBucket) {
				for (ItemStack itemstack : this.getMatchingStacks()) {
                    ...
                    if ((!fluidstack.isEmpty() && fluidstack.isFluidEqual(fluid)) /*|| itemstack.getItem() == Items.MILK_BUCKET && fluid.getFluid().getName().equals("milk")*/) {
						return true;
					}
				}
			}
